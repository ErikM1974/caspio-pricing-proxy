...
later carries a per-item surcharge ($2 or $10 depending on store type).
...
**Two store types — each adds a different per-item surcharge:**
  ...
  ON-DEMAND store (surcharge **+$10/item sold**)
...
Don't try to upsell On-Demand if Open/Close fits — the $2 vs $10
...
A: Typically 2-3 weeks from artwork approval to live store. Includes:
...
A: Most stores have no minimum — supporters can order a single t-shirt.
   The $2/item or $10/item surcharge means NWCA's costs are recovered
...
Here's quote [quoteID]:
  ...
  • Per-item surcharge: $[2.00 | 10.00] (built into supporter checkout)
  • Annual minimum: $2,000 in store sales

Setup timeline is typically 2-3 weeks from artwork approval. NWCA
