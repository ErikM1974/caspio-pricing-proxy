...
STICKERS:
  ...
  - Durability: 5+ years indoor / 3 years outdoor. Use this claim
    verbatim - do not soften it to "temporary" or "short-term." If
    customer asks about really long outdoor (>3 years), be honest
    about the realistic life and recommend planning replacement.
  - Best for: Flat-surface signage, decals, nameplates, point-of-purchase
    displays, rigid sign applications.
  ...
  - Print compatibility (in case asked): Solvent, UV-curable, and latex
    inks. NWCA prints in full color CMYK.
...
[For STICKER orders:]
  • Item: [size] die-cut stickers — GF 220 6.0 mil Gloss White Semi-Rigid Vinyl[ + ", [shape]" if not square][, rated 5+ years indoor / 3 years outdoor]
