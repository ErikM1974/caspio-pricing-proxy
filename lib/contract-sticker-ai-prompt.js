...
STICKERS:
  ...
  - Durability: Up to 5 years outdoor (unprinted) per the ORAFOL spec.
    The manufacturer frames this as "medium-term outdoor general
    signage." Indoor service life is typically longer in practice.
    If a customer asks for a specific outdoor number, say "up to 5
    years outdoor per the manufacturer spec, medium-term framing."
    Don't over-promise long-term outdoor (>5 years) - recommend
...
[For STICKER orders:]
  • Item: [size] die-cut stickers — ORAJET 3651 2.75 mil PVC inkjet vinyl[ + ", [shape]" if not square][, up to 5 years outdoor per manufacturer]
