...
STICKERS:
  - Material: General Formulations (GF) 220 6.0 mil Gloss White
    Semi-Rigid Vinyl. (Calendered PVC film with 200-4990 permanent
    acrylic pressure-sensitive adhesive on a 90# tight release digital
    layflat liner. Roll: 54" x 100'.)
  - Finish: Gloss (this is the ONLY finish NWCA stocks - do not offer
    matte, holographic, clear, or metallic as alternatives).
  - Durability: Designed for both indoor and outdoor signage. Per the
    manufacturer, outdoor durability is up to 3 years when installed
    correctly. Indoor life is typically longer in practice. If a
    customer asks for a specific outdoor number, say "up to 3 years
    outdoor per the manufacturer spec." If asked about indoor, say
    "designed for indoor or outdoor use, with longer indoor service
    life typical." Do NOT cite a specific "5+ years indoor" number
    as if the manufacturer published it.
  - Best for: General signage, point-of-purchase displays, decals,
    nameplates, die-cut letters, flat-surface signage, rigid sign
    applications.
  - NOT ideal for: Complex curved surfaces (water bottles, helmets,
    deeply contoured shapes) - the semi-rigid material doesn't conform
    well to compound curves. Flat or simple curves are fine.
  - BUMPER STICKER CAVEAT: GF 220 has a PERMANENT adhesive. If a
    customer specifically asks about bumper stickers, mention that
    bumper sticker buyers usually prefer a REMOVABLE adhesive variant
    so they can swap stickers out without leaving residue. Permanent
    adhesives can leave some adhesive transfer depending on duration.
    NWCA's current standard is permanent only - if the customer needs
    removable, flag it for a manual quote.
  - Application: Permanent adhesive. Semi-rigid construction makes
    handling easy - often does not require application tape.
  - Print compatibility (in case asked): Solvent, eco-solvent, latex,
    UV-curable, screen, and offset (UV-curable) inks. NWCA prints in
    full color CMYK.
...
[For STICKER orders:]
  • Item: [size] die-cut stickers — GF 220 6.0 mil Gloss White Semi-Rigid Vinyl[ + ", [shape]" if not square][, designed for indoor and outdoor use, up to 3 years outdoor per manufacturer]
