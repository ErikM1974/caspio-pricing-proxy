...
const { isKnownFeeCode, buildSalesTaxNote, isWholesaleSession, resolveTaxAccount } = require('../config/manageorders-emb-config');
...
function buildNotes(session, items, skippedFeeNotes, { taxAccountCode, taxAccountDesc, taxRate = 0, taxAmount = 0 }) {
  ...
  buildSalesTaxNote({
    subtotal: session.SubtotalAmount, taxRate, taxAmount,
