...
// Table reads go through the shared 15-min row cache (2026-09-06), same as the
// DTG and safety-stripe siblings. ?refresh=true bypasses; /api/product-cache/clear empties it.
